...
export type GenericLabelType = 
    ContextType | EmailSignUpLabelType | EmailLoginLabelType | EmailVerificationLabelType | 
    PasswordlessAuthenticationLabelType | GoogleAuthenticationLabelType | AddJobToQueueLabelType | 
