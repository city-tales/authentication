    ...
    async checkIfUserExists(
        ...
        try {
            ...
            if (
                ...
                response.statusCode = Constants.STATUS_CODES.OK;
                response.message =
                    Constants.GOOGLE_AUTHENTICATION_MESSAGE.NO_CONTENT;
            }
        } catch (error) {
    ...
    async authenticateUser(
        ...
        try {
            ...
            if (queryResponse.length === usersAuthDataQuery.length) {
                ...
                response.message =
                    Constants.GOOGLE_AUTHENTICATION_MESSAGE.CREATED;
                ...
                response.message =
                    Constants.GOOGLE_AUTHENTICATION_MESSAGE.FAILED;
            }
        } catch (error) {
            loggerDefaultParams = Helper.generateDefaultFailureParams(
                context.tracerId,
