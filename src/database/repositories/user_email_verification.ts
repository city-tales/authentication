...
class UserEmailVerificationRepositoriesImpl
    implements UserEmailVerificationRepositories
{
    async verifyEmail(
        decryptedAuthToken: DecryptedAuthTokenType,
        context: ContextType,
        ...
        try {
            ...
            if (Helper.isNeitherNullNorUndefinedNorEmpty(isKeyInRedis)) {
                ...
                const isEmailVerified: boolean = Helper.convertToType<boolean>(
            ...
            const userResponse: EmailVerificationResponse =
                await userEmailVerificationImpl.verifyEmail(
                    decryptedAuthToken,
                    context,
                    labels,
                );
...
export const userEmailVerificationRepositoriesImpl =
    new UserEmailVerificationRepositoriesImpl();
